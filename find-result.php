...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Om Srivastava">
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © <a href="https://omisrivastava.wordpress.com/">Om Srivastava</a> <?= date('Y') ?></small></p>
                    </div>
